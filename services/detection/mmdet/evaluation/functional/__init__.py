...
from .class_names import (cityscapes_classes, coco_classes,
                          ...
                          ppe_classes, hlr_classes, gh_classes, sse_classes, 
                          heavy_equipment_classes, heavy_equipment_coco_classes)
...
__all__ = [
    ...
    'evaluateImgLists', 'YTVIS', 'YTVISeval', 'ppe_classes', 'hlr_classes',
    'gh_classes', 'sse_classes', 'heavy_equipment_classes',
    'heavy_equipment_coco_classes'
]

...
def sse_classes() -> list:
    """Class names of PPE (Personal Protective Equipment)."""
    return [
        'scissor_lift', 
                   'worker_on_lift_safe', 
                   'worker_on_lift_unsafe', 
                   'worker_on_lift_rails', 
                   'worker_harness_lift', 
                   'worker_no_harness_lift',
                   'worker_increasing_lift_height', 
                   'boom_lift', 
                   'vertical_mast_lift', 
                   'misc_lift'
    ]

def ppe_classes() -> list:
    """Class names of PPE (Personal Protective Equipment)."""
    return [
        'gloves', 
        'hand', 
...
def hlr_classes() -> list:
    """Class names of HLR (Hazardous Ladder and Rebar)."""
    return [
        'rebar_no_cap', 
        'rebar_cap', 
        'puddle', 
        ...
        'ladder_job',
        'ladder', 
        'person_on_ladder_unsafe', 
        'person_on_ladder_safe', 
...
def gh_classes() -> list:
    """Class names of GH (Guardrail and Hazard)."""
    return [
        'proper_wooden_guardrail_with_netting', 
        'wooden_guardrail_without_toe_board', 
        'wooden_guardrail_without_middle_rail', 
        'tight_wire_rope_guardrail_with_netting', 
        'slack_wire_rope_guardrail', 
        'unprotected_leading_edge',
        'wire_rope_guardrail_without_netting', 
        'wooden_guardrail_without_netting', 
        'not_covered_floor_opening', 
        'partially_covered_floor_opening', 
        'covered_floor_opening',
        'metal_guardrail', 
        'electrical_outlet_hub', 
        'electrical_outlet_drop', 
        'electrical_outlet_spider_box', 
        'electrical_outlet_pole', 
        'fire_extinguisher'
    ]

def heavy_equipment_classes() -> list:
    """Class names of Heavy Equipment."""
    return [
        'excavator_treads', 
        'excavator_arm', 
        'person', 
...
def heavy_equipment_coco_classes() -> list:
    """Class names of Heavy Equipment COCO-format detection."""
    return [
        'excavator_treads', 
        'excavator_arm', 
        'person', 
